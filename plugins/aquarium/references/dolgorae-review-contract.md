...
This contract documents the Dolgorae consumer boundary of the upstream backend this edition does not use: no review workflow shipped here runs Dolgorae. Explicit Dolgorae setup and operations remain available through their owning workflows. Upstream binds its Aquarium review workflows to official stable Dolgorae releases from v0.1.2 through v0.1.x on Apple Silicon when its Independent Review route is enabled.
