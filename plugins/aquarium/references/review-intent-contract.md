...
The `/aquarium:independent-review` entrypoint owns the native reviewer-subagent route below and runs only that route. Apply this matrix before any discovery, setup, source handling, provider contact, or review launch:
