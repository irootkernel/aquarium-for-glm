---
name: mulgae-review
description: "Run one report-only standalone Mulgae review of an exact supported change target or named Task or Epic completion candidate. Use when the user explicitly invokes /aquarium:mulgae-review outside an active handler."
---
