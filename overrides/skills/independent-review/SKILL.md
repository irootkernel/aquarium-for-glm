...
description: "Run one supervised static review with fresh reviewer subagents against staged changes, `HEAD`, one commit or range, one task or epic, or a roadmap-independent investigation. Use when the user explicitly invokes /aquarium:independent-review and asks for an independent verdict without remediation."
---
